    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (metaDataList.get(position).getType()){
            case 0:
                ...
                break;
            case 1:
                int imgCase1=mContext.getResources().getIdentifier(metaDataList.get(position).getCover(),"mipmap",mContext.getPackageName());
                ...
                break;
            case 2:
                int imgCase2=mContext.getResources().getIdentifier(metaDataList.get(position).getCover(),"mipmap",mContext.getPackageName());
                ...
                break;
            case 3:
                int imgCase3=mContext.getResources().getIdentifier(metaDataList.get(position).getCover(),"mipmap",mContext.getPackageName());
                ...
                break;
            case 4:
                int img1=mContext.getResources().getIdentifier(metaDataList.get(position).getCovers()[0],"mipmap",mContext.getPackageName());
                int img2=mContext.getResources().getIdentifier(metaDataList.get(position).getCovers()[1],"mipmap",mContext.getPackageName());
                int img3=mContext.getResources().getIdentifier(metaDataList.get(position).getCovers()[2],"mipmap",mContext.getPackageName());
                int img4=mContext.getResources().getIdentifier(metaDataList.get(position).getCovers()[3],"mipmap",mContext.getPackageName());
